# Generated by Django 3.1.12 on 2021-10-26 09:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_url', models.URLField(verbose_name='图片联接')),
                ('is_active', models.BooleanField(default=False, verbose_name='是否是actice')),
            ],
            options={
                'verbose_name': '轮播图',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkurl', models.URLField(max_length=100, verbose_name='连接')),
            ],
            options={
                'verbose_name': '友情连接',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='推荐排行')),
            ],
            options={
                'verbose_name': '推荐排行',
                'verbose_name_plural': '推荐排行',
            },
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='文章')),
                ('excerpt', models.TextField(blank=True, max_length=200, verbose_name='摘要')),
                ('img', models.ImageField(blank=True, null=True, upload_to='article_img/', verbose_name='文章图片')),
